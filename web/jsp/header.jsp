                    ...
                    <c:otherwise>
                        <c:choose>
                            ...
                            <c:when test="${sessionScope.role =='ADMIN'}">
                                <li><a href="../jsp/profileUser.jsp"><fmt:message key="admin.profile.btn"/></a></li>
                                <li><a href="/controller?command=find_orders_in_process">Orders</a></li>
                                <li><a href="/controller?command=find_all_users">Users</a></li>
                                <li><a href="../jsp/adminMenu.jsp"><fmt:message key="menu.btn"/></a></li>
                            </c:when>
                        </c:choose>
